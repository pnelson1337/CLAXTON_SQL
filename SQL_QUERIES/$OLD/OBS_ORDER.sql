...
,ORD.VisitID,ORD.OrderedProcedureMnemonic,AV.AccountNumber,AV.Name,BV.AdmitDateTime					
...
WHERE ORD.Status != 'CANCEL' AND ORD.OrderedProcedureMnemonic IN ('OBSERVICU','OBSERVMS','OBSERVOB') 
AND BV.DischargeDateTime IS NULL AND BV.AdmitDateTime IS NULL AND AV.Status='ADM IN'
