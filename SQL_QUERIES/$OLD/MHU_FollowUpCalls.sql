...
,''														AS ' '
,CONVERT(VARCHAR(10),RXMORD.OrderDateTime,101)			AS 'OriginalApptDate'

,CASE WHEN COALESCE(FU12.Response,FU22.Response,FU32.Response,FU42.Response,FU52.Response) = 'RESCHED' 
	   AND COALESCE(FU14.Response,FU24.Response,FU34.Response,FU44.Response,FU54.Response) IS NULL THEN CONVERT(VARCHAR(10),CAST(COALESCE(FU13.Response,FU23.Response,FU33.Response,FU43.Response,FU53.Response) AS DATETIME),101)
	  ELSE CONVERT(VARCHAR(10),RXMORD.OrderDateTime,101) END AS 'ApptDateOrReschedDate'
...
,ISNULL(COALESCE(FU11.Response,FU21.Response,FU31.Response,FU41.Response,FU51.Response),'NO DATA')																					AS 'Attended?'
,ISNULL(COALESCE(FU12.Response,FU22.Response,FU32.Response,FU42.Response,FU52.Response),'NO DATA')																					AS 'Reason(IF NO)'
,ISNULL(COALESCE(FU13.Response,FU23.Response,FU33.Response,FU43.Response,FU53.Response),'')																							AS 'Rescheduled Date'
,ISNULL(COALESCE(FU14.Response,FU24.Response,FU34.Response,FU44.Response,FU54.Response),'NO DATA')																					AS 'Attended Resched?'
,ISNULL(COALESCE(FU153.Response,FU253.Response,FU353.Response,FU453.Response,FU553.Response),'NO DATA')																				AS 'Follow-Up - 1'
,ISNULL(COALESCE(FU163.Response,FU263.Response,FU363.Response,FU463.Response,FU563.Response),'NO DATA')																				AS 'Follow-Up - 2'
,ISNULL(COALESCE(FU173.Response,FU273.Response,FU373.Response,FU473.Response,FU573.Response),'NO DATA')																				AS 'Follow-Up - 3'
...
,CASE WHEN COALESCE(FU11.Response,FU21.Response,FU31.Response,FU41.Response,FU51.Response) IS NULL THEN 'FIRST CLINIC VISIT'
	  WHEN COALESCE(FU12.Response,FU22.Response,FU32.Response,FU42.Response,FU52.Response) = 'RESCHED' 
	   AND COALESCE(FU14.Response,FU24.Response,FU34.Response,FU44.Response,FU54.Response) IS NULL THEN 'RESCHED CLINIC VIST'
...
WHERE X.[Attended?] IN ('N','NO DATA')
AND X.[Reason(IF NO)] NOT IN ('PTCAN','REHOSP')
AND X.[Attended Resched?] IN ('N', 'NO DATA')
AND X.[Follow-Up - 1] IN ('NA','LM','OTH','NO DATA')
AND X.[Follow-Up - 2] IN ('NA','LM','OTH','NO DATA')
AND X.[Follow-Up - 3] IN ('NO DATA')
AND X.OriginalApptDate IS NOT NULL
AND X.InpatientServiceID='MHC'

--AND X.ApptDate < GETDATE()-1
AND (X.OriginalApptDate < GETDATE()-1 AND X.[Rescheduled Date] < GETDATE()-1)



ORDER BY X.CallType ,X.ApptLoc,X.OriginalApptDate