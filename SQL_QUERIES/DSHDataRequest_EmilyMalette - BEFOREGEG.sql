...
-- END OF NAME SPLIT--
 ...
 -- AS 'Mother’s Acct/MRN #'
 -- AS 'Mother’s Name'
 ,BV1.VisitID
 ,BV1.AccountNumber
 ,BV1.Name

 --,BV.AdmitSourceNewbornID
...
FULL OUTER JOIN		[Livedb].[dbo].[BarVisits]							AS BV1		 ON BV.VisitID=BV1.MothersVisitID
...
AND BVF.ChargeTotal > '0'
AND BV.VisitID='6011615686'


ORDER BY BVF.ChargeTotal