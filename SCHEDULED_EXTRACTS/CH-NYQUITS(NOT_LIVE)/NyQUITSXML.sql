...
SELECT 
(SELECT '[physicianid]' AS 'loginid','[password]' AS 'password','XXXNNN' AS 'groupcode' FOR XML PATH('sender'),TYPE,ELEMENTS)
...
FOR XML PATH('client'),TYPE,ELEMENTS
) 
FOR XML PATH(''),ROOT('ref2qxml'),ELEMENTS
