...
,(Select bd.DiagnosisCodeID
				 from [CH_MTLIVE].[dbo].[BarDiagnoses]bd
...
--LEFT JOIN [CH_MTLIVE].[dbo].[BarUniqueClaimReferenceData]		AS UCRN	ON ct.VisitID=UCRN.VisitID
...
FROM [CH_MTLIVE].[dbo].[BarCollectionTransactions]		AS  ct
