...
INNER JOIN			[CH_MTLIVE].[dbo].[BarSurgicalProcedures]							AS BSP		 ON BV.BillingID=BSP.BillingID
--INNER JOIN			[CH_MTLIVE].[dbo].[AbsDrgProcedures]								AS AbsProc	 ON BV.VisitID=AbsProc.VisitID				
