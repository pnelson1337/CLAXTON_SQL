...
LEFT OUTER JOIN		[Livedb].[dbo].[AbsDrgProcedures]								AS AbsProc	 ON BV.VisitID=AbsProc.VisitID						AND AbsProc.ProcedureSeqID='1'
INNER JOIN			[Livedb].[dbo].[AdmVisitQueries]								AS ETH		 ON	AV.VisitID=ETH.VisitID							AND ETH.QueryID='ETHNICITY'
INNER JOIN			[Livedb].[dbo].[AdmVisitQueries]								AS LANG		 ON	AV.VisitID=LANG.VisitID							AND LANG.QueryID='ADM.LANG'
...
--LEFT OUTER JOIN		[Livedb].[dbo].[AbsOperationSurgeons]							AS SURGEON	 ON BV.VisitID=SURGEON.VisitID						AND SURGEON.ProviderSeqID='1' AND SURGEON.OperationSeqID='1'
